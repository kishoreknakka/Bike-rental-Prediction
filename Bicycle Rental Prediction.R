...
setwd("~/Users/kishorekumar/Documents/Kishore/All Docs/Business Analytics/MyCSUEB/5 Capstone/Kishore Capstone")
getwd()
#Load Libraries
...
#histograms
hist(day$cnt, breaks = 25, main = 'Distribution of Total Bike Rental Count',
     ylab = 'Frequency of Rental', xlab = 'Total Bike Rental Count', col = 'blue' )
...
#checking for irregular residuals
...
#mape values
mapee(test_data[,16], pr) #decision Tree
mapee(test_data[,16], predictions) #lin reg

#mape value for linear regression model is 33.13
#mape value for Decision tree regression model is 30.24